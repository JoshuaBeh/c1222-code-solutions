...
export default function App() {
  ...
  function handleSubmit(event) {
     ...
     *   1. "caption" the value of caption
     *   2. "image" the value of fileInputRef.current.files[0]
     *
     ...
     *   assign null to fileInputRef.current.value to clear the file
