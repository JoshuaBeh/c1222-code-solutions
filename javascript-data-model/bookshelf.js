...
console.log('author of 2nd book value:', bookshelf[1].author);
console.log('isbn of 1st book value:', bookshelf[0].isbn);
console.log('title of 3rd book value:', bookshelf[2].title);
